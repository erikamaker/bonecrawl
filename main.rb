...
# Intended use: game engine for creating content on PC and mobile platforms. 
...
def room_2.overview
    ...
    puts "	     the western wall. Every other"
    puts "	     way leads to an exit.\n\n"
end

chest_1 = Chest.new
chest_1.minimap = [[0,5,-4]]
chest_1.content = Knife1.new
...
drug_1 = Crystal.new
drug_1.minimap = [[0,5,-4]]

gem_1 = Pink.new
gem_1.minimap = [[0,1,2]]
def gem_1.backdrop 
    puts "	   - TEST. A GEM SITS HERE.\n\n"
end


level_1 = [ room_1, gem_1, drain_1, door_1, hook_1, key_1, door_2, door_3, torch_1, table_1, food_1, pull_1, pick_1, drug_1 ]
